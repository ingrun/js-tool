            ...
            <div class="regex-rules">
                ...
                <el-col :span="12">
                  ...
                  <el-descriptions :column="1" size="small" border>
                    <el-descriptions-item label="."
                      >匹配除换行符外的任意字符</el-descriptions-item
                    >
                    <el-descriptions-item label="\d"
                      >匹配数字，等价于[0-9]</el-descriptions-item
                    >
                    <el-descriptions-item label="\D"
                      >匹配非数字字符</el-descriptions-item
                    >
                    <el-descriptions-item label="\w"
                      >匹配字母、数字或下划线</el-descriptions-item
                    >
                    <el-descriptions-item label="\W"
                      >匹配非字母、数字或下划线</el-descriptions-item
                    >
                    <el-descriptions-item label="\s"
                      >匹配空白字符</el-descriptions-item
                    >
                    <el-descriptions-item label="\S"
                      >匹配非空白字符</el-descriptions-item
                    >
                  </el-descriptions>
                </el-col>
                <el-col :span="12">
                  ...
                  <el-descriptions :column="1" size="small" border>
                    <el-descriptions-item label="*"
                      >匹配前面的子表达式零次或多次</el-descriptions-item
                    >
                    <el-descriptions-item label="+"
                      >匹配前面的子表达式一次或多次</el-descriptions-item
                    >
                    <el-descriptions-item label="?"
                      >匹配前面的子表达式零次或一次</el-descriptions-item
                    >
                    <el-descriptions-item label="{n}"
                      >匹配确定的n次</el-descriptions-item
                    >
                    <el-descriptions-item label="{n,}"
                      >至少匹配n次</el-descriptions-item
                    >
                    <el-descriptions-item label="{n,m}"
                      >最少匹配n次，最多匹配m次</el-descriptions-item
                    >
                  </el-descriptions>
                </el-col>
              </el-row>
              <el-row :gutter="20" style="margin-top: 20px">
                <el-col :span="12">
                  ...
                  <el-descriptions :column="1" size="small" border>
                    <el-descriptions-item label="^"
                      >匹配输入字符串的开始位置</el-descriptions-item
                    >
                    <el-descriptions-item label="$"
                      >匹配输入字符串的结束位置</el-descriptions-item
                    >
                    <el-descriptions-item label="\b"
                      >匹配一个单词边界</el-descriptions-item
                    >
                    <el-descriptions-item label="\B"
                      >匹配非单词边界</el-descriptions-item
                    >
                  </el-descriptions>
                </el-col>
                <el-col :span="12">
                  ...
                  <el-descriptions :column="1" size="small" border>
                    <el-descriptions-item label="|"
                      >指明两项之间的一个选择</el-descriptions-item
                    >
                    <el-descriptions-item label="[]"
                      >匹配方括号内的任意字符</el-descriptions-item
                    >
                    <el-descriptions-item label="()"
                      >标记一个子表达式的开始和结束位置</el-descriptions-item
                    >
                    <el-descriptions-item label="\"
                      >转义下一个字符</el-descriptions-item
                    >
                  </el-descriptions>
                </el-col>
              </el-row>
        ...
        <el-card class="regex-cheatsheet-card">
          ...
          <el-table :data="cheatsheetData" style="width: 100%" stripe>
            ...
            <el-table-column label="操作" width="120">
              <template #default="scope">
                <el-button size="small" @click="useRegex(scope.row.pattern)"
                  >使用</el-button
                >
              </template>
            </el-table-column>
...
const cheatsheetData = [
  ...
  },
  {
    ...
    description: "匹配HTTP或HTTPS链接",
  },
  {
    name: "IP地址",
    pattern:
      "\\b(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\b",
    description: "匹配有效的IPv4地址",
  },
  {
    name: "日期格式",
    pattern: "^\\d{4}-\\d{2}-\\d{2}$",
